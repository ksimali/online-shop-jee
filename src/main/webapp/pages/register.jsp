            ...
            <div class="col-md-9">
				<form action="${pageContext.request.contextPath}/auth" method="POST" style="margin-left: 100px;">
                    ...
                    <div class="btn-register">
                        ...
                        <button type="button" id="btn-login-login" class="btn btn-secondary" onclick="window.location.href='${pageContext.request.contextPath}/auth?action=login'">Deja un compte?</button>  
                    </div>
                </form>
